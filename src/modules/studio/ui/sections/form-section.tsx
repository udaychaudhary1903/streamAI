...
import { VideoPlayer } from "@/src/modules/videos/ui/components/video-player";
...
import { videoUpdateSchema } from "@/src/db/schema";  
...
import { THUMBNAIL_FALLBACK } from "@/src/modules/videos/constants";
...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
  ...
  const generateTitle = trpc.videos.generateTitle.useMutation({
    onSuccess: () => {
      toast.success("Title generation started", { description: "It may take a few seconds to appear" });
    },
    onError: () => {
      toast.error("Something went wrong");
    },
